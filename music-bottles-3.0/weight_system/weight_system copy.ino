...
const int scaleAvgReadCount = 4;
const int scaleReadInterval = 20*scaleAvgReadCount; // number of millisecs between blinks
...
void readScale() {
  ...
  if (currentMillis - previousScaleMillis >= scaleReadInterval) {
    ...
    double avgWeight = scale.read_average(scaleAvgReadCount);
